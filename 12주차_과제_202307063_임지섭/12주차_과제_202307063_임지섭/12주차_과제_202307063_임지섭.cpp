...
#include "framework.h"
#include "12주차_과제_202307063_임지섭.h"
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
       ...
       ///자식 윈도우창 찾기
        g_child = FindWindow(NULL, L"12주차_child");
        /*
        if (NULL != g_child)
        {
    ...
    case WM_LBUTTONDOWN:
    {
        ...
        PostMessage(g_child,WM_LBUTTONDOWN,NULL,lParam);
    }
        break;
    ...
    case WM_MOUSEMOVE:
    {
        if (x < area.left + 10) {
            darw = false;
            PostMessage(g_child, WM_USER+7, NULL, NULL);
        }
        ...
        PostMessage(g_child, WM_MOUSEMOVE, NULL, lParam);
    }
        break;
    ...
    case WM_LBUTTONUP:
    {
        ...
        DeleteObject(myPen);
        ReleaseDC(hWnd, hdc);
        PostMessage(g_child, WM_LBUTTONUP, NULL, lParam);
    }
        break;
    ...
    case WM_COMMAND:
    {
        ...
        case eraser_id:
        {
            ...
            PostMessage(g_child, WM_COMMAND, 999, 0);
        }
            break;
        ...
        case ID_32771:
            g_drawType = 0;
            PostMessage(g_child, WM_USER, NULL, NULL);
            break;

            ///사각형 그리기
        case ID_32772:
            g_drawType = 1;
            PostMessage(g_child, WM_USER+1, NULL, NULL);
            break;

            ///타원 그리기
        case ID_32773:
            g_drawType = 2;
            PostMessage(g_child, WM_USER + 2, NULL, NULL);
            break;

            ///자유선 그리기
        case ID_32774:
            g_drawType = 3;
            PostMessage(g_child, WM_USER + 3, NULL, NULL);
            break;

            ///면색 흰색
        case ID_32775:
            g_backgroud = 0;
            PostMessage(g_child, WM_USER + 4, NULL, NULL);
            break;

            ///면색 보라색
        case ID_32776:
            g_backgroud = 1;
            PostMessage(g_child, WM_USER + 5, NULL, NULL);
            break;

            ///면색 파란색
        case ID_32777:
            g_backgroud = 2;
            PostMessage(g_child, WM_USER + 6, NULL, NULL);
            break;
